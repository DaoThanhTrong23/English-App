...
Authrouter.post('/google', validate(GoogleLoginSchema), asyncHandler(async (req, res) => {
...
Authrouter.post('/facebook', validate(FacebookLoginSchema), asyncHandler(async (req, res) => {
